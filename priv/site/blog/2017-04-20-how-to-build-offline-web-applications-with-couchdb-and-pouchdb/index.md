...
![A sequence diagram with the browser, the web application and CouchDB](./diagram.png)
...
![A screenshot of Fauxton](./couchdbweb.png)
...
A common question about PouchDB is how much data can we store with it? Chrome,
